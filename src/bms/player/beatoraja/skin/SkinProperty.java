...
public class SkinProperty {
	...
	public static final int TIMER_SCORE_AAA = 350;
	public static final int TIMER_SCORE_BEST = 351;
	public static final int TIMER_SCORE_TARGET = 352;
	...
	public static final int BARGRAPH_LEVEL_BEGINNER = 105;
	public static final int BARGRAPH_LEVEL_NORMAL = 106;
	public static final int BARGRAPH_LEVEL_HYPER = 107;
	public static final int BARGRAPH_LEVEL_ANOTHER = 108;
	public static final int BARGRAPH_LEVEL_INSANE = 109;
	public static final int BARGRAPH_SCORERATE = 110;
	public static final int BARGRAPH_SCORERATE_FINAL = 111;
	public static final int BARGRAPH_BESTSCORERATE_NOW = 112;
	public static final int BARGRAPH_BESTSCORERATE = 113;
	public static final int BARGRAPH_TARGETSCORERATE_NOW = 114;
	public static final int BARGRAPH_TARGETSCORERATE = 115;

	public static final int BARGRAPH_RATE_PGREAT = 140;
	public static final int BARGRAPH_RATE_GREAT = 141;
	public static final int BARGRAPH_RATE_GOOD = 142;
	public static final int BARGRAPH_RATE_BAD = 143;
	public static final int BARGRAPH_RATE_POOR = 144;
	public static final int BARGRAPH_RATE_MAXCOMBO = 145;
	public static final int BARGRAPH_RATE_SCORE = 146;
	public static final int BARGRAPH_RATE_EXSCORE = 147;
	...
	public static final int NUMBER_GROOVEGAUGE_AFTERDOT = 407;
	public static final int NUMBER_DIFF_EXSCORE = 108;
	public static final int NUMBER_PERFECT = 110;
	public static final int NUMBER_EARLY_PERFECT = 410;
	public static final int NUMBER_LATE_PERFECT = 411;
	public static final int NUMBER_GREAT = 111;
	public static final int NUMBER_EARLY_GREAT = 412;
	public static final int NUMBER_LATE_GREAT = 413;
	public static final int NUMBER_GOOD = 112;
	public static final int NUMBER_EARLY_GOOD = 414;
	public static final int NUMBER_LATE_GOOD = 415;
	public static final int NUMBER_BAD = 113;
	public static final int NUMBER_EARLY_BAD = 416;
	public static final int NUMBER_LATE_BAD = 417;
	public static final int NUMBER_POOR = 114;
	public static final int NUMBER_EARLY_POOR = 418;
	public static final int NUMBER_LATE_POOR = 419;
	public static final int NUMBER_MISS = 420;
	public static final int NUMBER_EARLY_MISS = 421;
	...
	public static final int OPTION_REPLAYDATA_SAVED = 198;
	public static final int OPTION_NO_REPLAYDATA2 = 1196;
	public static final int OPTION_REPLAYDATA2 = 1197;
	public static final int OPTION_REPLAYDATA2_SAVED = 1198;
	public static final int OPTION_NO_REPLAYDATA3 = 1199;
	public static final int OPTION_REPLAYDATA3 = 1200;
	public static final int OPTION_REPLAYDATA3_SAVED = 1201;
	...
	public static final int OFFSET_JUDGEDETAIL_2P = 33;
